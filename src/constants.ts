...
export const INFO_MESSAGES = {
  ...
  TRANSACTION_TIMEOUT: '⏱️ Transaction request timed out. Please try /transact again if you wish to proceed.',
  TRANSACTION_CANCELED: '❌ Transaction canceled.',
  INVALID_RESPONSE: '❌ Invalid response. Please reply with YES or NO.\n\nTo start a new transaction, use /transact again.',
};
